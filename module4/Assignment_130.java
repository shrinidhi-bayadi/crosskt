...
public class Assignment_130 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement passport=driver.findElement(By.xpath("(//div[@class='css-1dbjc4n r-1awozwy r-1kihuf0 r-rs99b7 r-1loqt21 r-1777fci r-1otgn73 r-1i6wzkk r-lrvibr'])[2]"));
		passport.click();
		Thread.sleep(2000);
		WebElement city=driver.findElement(By.xpath("//select[@class='r-14lw9ot r-ry2h4h r-1f0042m r-rs99b7 r-1qd0xha r-1b43r93 r-eu3ka r-crgep1 r-1hfyk0a']"));
