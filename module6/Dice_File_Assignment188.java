...
//Write a Selenium program to automate the upload of a resume on Naukri.com or any other recruitment website.
public class Dice_File_Assignment188 {
...
// 5 sec wait time to accept cookies manually
		Thread.sleep(5000);
		...
		WebElement pop=wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@aria-label='Close']")));
		pop.click();
